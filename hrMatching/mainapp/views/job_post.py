...
class Job_PostUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse(
            "job_post_update", kwargs={"pk": self.object.job_id, "changed": 1}
        )
...
class Job_Post_Company_ListView(
    LoginRequiredMixin, UserPassesTestMixin, Job_PostListView
):
